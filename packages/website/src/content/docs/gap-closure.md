...
The execute workflow detects which plans still need completion and runs only those. You do not need to specify individual fix phases. MaxsimCLI determines this from the filesystem by checking which plans lack a SUMMARY.md.
