...
The execute workflow detects which plans still need completion by checking GitHub Issue status on the Project Board and runs only those. You do not need to specify individual fix phases.
