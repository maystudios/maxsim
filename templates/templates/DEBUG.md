...
Template for a GitHub Issue labeled `bug` — active debug session tracking.
...
**Creation:** Immediately when /maxsim:debug is called
...
**On resolution:**
- status → "resolved"
- Close the GitHub Issue (only after user confirms fix)
